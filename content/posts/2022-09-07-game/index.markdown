...
{{< img src="imgs/jinshan.jpg" width="40%" style="display: block; margin: auto;" loading="lazy" decoding="async" >}}
...
{{< img src="imgs/fu.jpg" width="40%" style="display: block; margin: auto;" loading="lazy" decoding="async" >}}

一共玩了两次，第一次认认真真，确保正确率，玩到159万分；第二次发现了好办法，当后面眼花缭乱的时候，开启「摆烂」模式：直接乱敲键盘，理想状态就是26键一起下去。然而，这竟是一个更好的策略。当我祭出神魔乱舞，屏幕上的敌机就被悉数毁灭。


{{< img src="imgs/scores.jpg" width="40%" style="display: block; margin: auto;" loading="lazy" decoding="async" >}}
...
{{< img src="index_files/figure-html/unnamed-chunk-4-1.png" width="35%" style="display: block; margin: auto;" >}}
