...
1.  再次尝试在市场部周会中引入书面汇报，后期看下结果吧。
2.  给新来的算法工程师讲解了之前设计的产品思路和代码，好在当时有「先见之明」重构过代码，讲起来很流畅。

生活：

1.  周五周六（0419-0420）小表姐结婚。
2.  周日（0421）和 PL、LT 青山湖骑行。
