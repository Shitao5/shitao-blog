...
另外发现：在日期计算中涉及到月份计算需格外小心，因为月末天数不一致，很容易产生意料之外的问题（比如说 3 月 31 日往前推 1 个月，如果写 `ymd("2023-03-31") - months(1)` 则会返回 `NA`，因为 2 月没有 31 日，正确的写法是 `ymd("2023-03-31") %m-% months(1)`），需熟练掌握 **lubridate** 的功能，[速查表](https://github.com/rstudio/cheatsheets/blob/main/lubridate.pdf)写得很详细。
